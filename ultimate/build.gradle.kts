...
bunched(Bunch.IJ) {
    ...
    dependencies {
        ...
        if (intellijUltimateEnabled) {
            ...
            bunched(Bunch.`181+`) {
                compileOnly(intellijUltimateDep()) { includeJars("platform-api", "platform-impl", "java-api", "java-impl") }
            }
        ...
        if (intellijUltimateEnabled) {
            ...
            bunched(Bunch.`181+`) {
                testCompileOnly(intellijUltimateDep()) { includeJars("platform-api", "platform-impl") }
            }
        }
